...
public:
  ...
  // be incomplete.
  virtual NetExpr *elaborate_expr(Design *des, NetScope *scope, int expr_width,
...
public:
  ...
  virtual void dump(ostream &os) const { return ex->dump(os); }
  ...
  virtual NetExpr *elaborate_expr(Design *des, NetScope *sc, int w,
                                  bool s) const {
...
public:
  ...
  virtual NetNet *elaborate_lnet(Design *des, NetScope *scope) const;
  virtual NetNet *elaborate_bi_net(Design *des, NetScope *scope) const;
  virtual NetExpr *elaborate_expr(Design *des, NetScope *, int expr_width,
                                  bool sys_task_arg) const;
...
private:
  NetExpr *elaborate_expr_param_(Design *des, NetScope *scope,
                                 const NetExpr *par, NetScope *found,
  ...
  NetExpr *elaborate_expr_net(Design *des, NetScope *scope, NetNet *net,
                              NetScope *found, bool sys_task_arg) const;
  ...
  NetExpr *elaborate_expr_net_part_(Design *des, NetScope *scope,
                                    NetESignal *net, NetScope *found) const;
...
protected:
  ...
  NetExpr *elaborate_expr_base_(Design *, NetExpr *lp, NetExpr *rp, int use_wid,
                                bool is_pexpr = false) const;
...
public:
  ...
  NetExpr *elaborate_expr(Design *des, NetScope *scope, int expr_width,
                          bool sys_task_arg) const;
...
public:
  ...
  virtual NetExpr *elaborate_expr(Design *des, NetScope *scope, int expr_wid,
                                  bool sys_task_arg) const;
  virtual NetExpr *elaborate_pexpr(Design *des, NetScope *sc) const;
...
private:
  ...
  NetExpr *elaborate_access_func_(Design *des, NetScope *scope,
                                  ivl_nature_t) const;
  unsigned test_width_sfunc_(Design *des, NetScope *scope, unsigned min,
                             unsigned lval, ivl_variable_type_t &expr_type,
                             bool &unsized_flag);
};
